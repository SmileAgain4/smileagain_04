...
<div class="mbskin">
	...
	<div id="register_form" class="form_01">   
		...
		<div class="tbl_frm01 tbl_wrap">
	        ...
	        <ul>
	            <li>
	                <label for="b_title"><i class="fas fa-user-lock"></i>블로그 이름</label>
	                <input type="text" id="b_title" name="mb_1" value="<?php echo get_text($member['mb_1']) ?>" class="frm_input half_input <?php echo $required ?> <?php echo $readonly ?>" size="10" placeholder="Input Title of BLOG" />
	            </li>
	            <li>
	                <label for="b_info" class="sound_only"><i class="fas fa-info-circle"></i>개인정보 / 사업자정보</label>
	                <input type="text" name="mb_2" value="<?php echo get_text($member['mb_2']) ?>" id="b_info" required class="frm_input email full_input required" size="70" maxlength="100" placeholder="정보를 입력하세요.">
	            </li>
				
	            <li>
	                <input type="text" name="mb_3" value="<?php echo get_text($member['mb_3']) ?>" id="b_location" class="frm_input full_input" size="50"  placeholder="Location / Address">
	                <label for="b_location" class="sound_only">위치</label><br>

	                <input type="text" name="mb_4" value="<?php echo get_text($member['mb_4']) ?>" id="b_introduce" class="frm_input full_input" size="200"  placeholder="소개">
	                <label for="b_introduce" class="sound_only">소개</label><br>
	            </li>
