...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div id="bo_btn_top">
        ...
        <ul class="btn_bo_user">
            ...
            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b02 btn">블로그 개설</a></li><?php } ?>
        </ul>
        <?php } ?>
    </div>
    <!-- } 게시판 페이지 정보 및 버튼 끝 -->
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <td class="td_subject" style="padding-left:<?php echo $list[$i]['reply'] ? (strlen($list[$i]['wr_reply'])*10) : '0'; ?>px">
                ...
                <?php } ?>
                <div class="bo_tit">
                    <!-- 190507 BLOG 게시판에서 글제목 클릭시 새창으로 미니홈피 열기 -->
                    <a href="<?php echo $list[$i]['href'] ?>"
                        onClick="window.open('<?php echo $list[$i]["href"]?>','pagename','resizable,height=880,width=1200'); return false;">
