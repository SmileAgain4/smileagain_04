...
<section id="bo_w">
    ...
    <div class="bo_w_tit write_div">
        <span style="font-family:'Yeon Sung', cursive; font-size : 2em"><i class="fab fa-blogger fa-2x"></i> Blog Title : <span style="font-size:1.5em; font-weight: bold"><?php echo $mb['mb_1'] ?></span></span>

        <div id="autosave_wrapper write_div" style="display: none">
            <input type="text" name="wr_subject" value="<?php echo $mb['mb_1'] ?>" id="wr_subject" required class="frm_input full_input required" size="50" maxlength="255" placeholder="">
        </div>
    ...
    <div class="write_div">
        <br/>
        <span style="font-family:'Yeon Sung', cursive; font-size:2em"><i class="far fa-address-card fa-2x"></i>Blog 소개 </span>
        <div class="wr_content <?php echo $is_dhtml_editor ? $config['cf_editor'] : ''; ?>">
            
            <?php  echo $editor_html; // 에디터 사용시는 에디터로, 아니면 textarea 로 노출 ?>
            <!-- wr_content는 Blog - Home - 소개 에 들어감 -->
        </div>
