...
add_stylesheet('<link rel="stylesheet" href="'.G5_THEME_URL.'/css/smile.css">', 0);
?>
...
<div id="hd">
    ...
    <div id="hd_wrapper">
		...
		<div id="hd_wr">
	        <div id="main_title">
	        	<a href="<?php echo G5_URL ?>">SMILE AGAIN : Sharing Economy</a>
	        </div>
...
<div id="wrapper">
    ...
    <div id="main_bn">
        <ul class="bn_ul">
            <li class="bn_bg1">
                <div class="bn_wr"><a href="#none"><img src="<?php echo G5_THEME_IMG_URL ?>/main_1.jpg" alt="메인베너" /></a></div>
            </li>
            <li class="bn_bg1">
                <div class="bn_wr"><a href="#none"><img src="<?php echo G5_THEME_IMG_URL ?>/main_2.jpg" alt="메인베너" /></a></div>
            </li>
            <li class="bn_bg1">
                <div class="bn_wr"><a href="#none"><img src="<?php echo G5_THEME_IMG_URL ?>/main_3.jpg" alt="메인베너" /></a></div>
            </li>
            <li class="bn_bg1">
                <div class="bn_wr"><a href="#none"><img src="<?php echo G5_THEME_IMG_URL ?>/main_4.jpg" alt="메인베너" /></a></div>
            </li>
            <li class="bn_bg1">
                <div class="bn_wr"><a href="#none"><img src="<?php echo G5_THEME_IMG_URL ?>/main_5.jpg" alt="메인베너" /></a></div>
            </li>
            <li class="bn_bg1">
                <div class="bn_wr"><a href="#none"><img src="<?php echo G5_THEME_IMG_URL ?>/main_6.jpg" alt="메인베너" /></a></div>
            </li>
            <li class="bn_bg1">
                <div class="bn_wr"><a href="#none"><img src="<?php echo G5_THEME_IMG_URL ?>/main_7.jpg" alt="메인베너" /></a></div>
            </li>
        </ul>
    </div>
	<!--} 메인배너-->
