 ...
 <div id="register_form"  class="form_01">   
    <div>
        ...
        <ul>
            <li>
                ...
                <span class="frm_info">영문자, 숫자, _ 만 입력 가능. 최소 33자이상 입력하세요.</span>
            </li>
            <li>
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <ul>
            ...
            <li>
                <label for="reg_mb_tel" class="sound_only">전화번호<strong>필수</strong></label>
                <input type="text" name="mb_tel" value="<?php echo get_text($member['mb_tel']) ?>" id="reg_mb_tel" required class="frm_input half_input required" maxlength="20" placeholder="전화번호">
            </li>
...
<!-- 190509 블로그 정보 추가 -->
    <div class="tbl_frm01 tbl_wrap">
        ...
        <ul> 
            <li>
                <label for="b_title"><i class="fab fa-blogger"></i>블로그 이름</label>
                <input type="text" id="b_title" name="mb_1" value="<?php echo get_text($member['mb_1']) ?>" required class="frm_input half_input required" size="10" placeholder="Input Title of BLOG">
            </li>
            <li>
                <label for="b_info"><i class="fas fa-info-circle"></i>개인정보 / 사업자정보</label>
                <input type="text" name="mb_2" value="<?php echo get_text($member['mb_2']) ?>" id="b_info" required class="frm_input full_input required" size="70" maxlength="100" placeholder="정보를 입력하세요.">
            </li>
            
            <li>
                <label for="b_location"><i class="fas fa-map-marked-alt"></i>위치</label>
                <input type="text" name="mb_3" value="<?php echo get_text($member['mb_3']) ?>" id="b_location" required class="required frm_input full_input" size="50"  placeholder="Location / Address">
            </li>
            <li>
                <label for="b_introduce"><i class="fas fa-portrait"></i>블로그 소개</label>
                <input type="text" name="mb_4" value="<?php echo get_text($member['mb_4']) ?>" id="b_introduce" required class="required frm_input full_input" size="200"  placeholder="">
            </li>
